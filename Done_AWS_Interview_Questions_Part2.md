...
## IMP - What are the different types of EC2 instances based on their costs?
...
## IMP - What is Geo-Targeting in CloudFront?
...
## IMP - Explain Connection Draining.
...
## IMP - What is the use of lifecycle hooks is Autoscaling?
...
## IMP - List of the benefits of using Amazon Dynamodb?
...
## IMP - What is a Dynamodbmapper Class?
...
## IMP - What are the Data Types supported by Dynamodb?
...
## IMP - What is a Data Warehouse and how AWS Redshift can play a vital role in the Storage?
...
## IMP - What is Amazon Redshift and why is it popular among other Cloud Data Warehouses?
...
## IMP - What is a Leader Node and Compute Node?
...
## IMP - How to load data iIn Amazon Redshift?
...
## IMP - What is the work of Amazon RDS?
...
## IMP - Are RDS instances upgradable or downgradable according to the Need?
...
## IMP - Is it possible to run Multiple Db Instances for free for Amazon Rds?
...
## IMP - What will happen to the Db Snapshots and Backups if any user deletes Db Instance?
